...
CREATE TABLE IF NOT EXISTS experiments (experiment_id TEXT PRIMARY KEY, data_version TEXT NOT NULL, strategy_version TEXT NOT NULL, code_version TEXT NOT NULL, parameters JSONB NOT NULL, universe JSONB NOT NULL, timeframe TEXT NOT NULL, start_date TIMESTAMPTZ NOT NULL, end_date TIMESTAMPTZ NOT NULL, transaction_costs JSONB NOT NULL, slippage JSONB NOT NULL, random_seed INTEGER, created_at TIMESTAMPTZ NOT NULL DEFAULT now());
