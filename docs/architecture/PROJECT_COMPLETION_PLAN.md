...
- [x] API market-data window hardening — candle/SMC queries now use half-open `[start, end)` semantics and reject naive query timestamps, with integration coverage
