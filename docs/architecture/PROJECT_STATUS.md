...
- Deterministic experiment strategy-comparison ranking by return then drawdown, with unit tests.
...
- Latest CI for the current research changes remains pending verification.
...
1. Verify current Python and Web CI runs and fix any failures.
...
5. Integrate research comparison/reporting into the running experiment workflow/dashboard where applicable.

## Next dependency
After CI verification, integrate strategy comparison and report generation into the experiment-facing application path. Advanced options, microstructure, ML, AI-agent, execution, SaaS and hardening remain later dependencies.
